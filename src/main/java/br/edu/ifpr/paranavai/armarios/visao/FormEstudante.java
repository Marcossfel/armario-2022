...
public class FormEstudante extends javax.swing.JFrame {
    ...
    public FormEstudante(int codigo) {
        initComponents();
        this.estudante = EstudanteControle.buscarPorId(codigo);
        panelFormulario.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados da Localização " + this.estudante.getEstudanteId()));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (this.estudante.getEstudanteId() == null) {
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEstudante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormEstudante().setVisible(true);
            }
        });
    }
